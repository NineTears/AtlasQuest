...
Inst6Quest6_Aim = "从维克多·奈法里奥斯领主领主那里取回《沃根多尔：血之维度的神话》的一份副本。"
...
Inst39Quest1_Location = "流亡者格罗尔（灰谷，在阿斯特兰纳和费伍德之间的道路上，靠近北方的熊怪营地；"..YELLOW.."56.1,59.2"..WHITE.."）。"
...
Inst39Quest2_Location = "流亡者格罗尔（灰谷，在阿斯特兰纳和费伍德之间的道路上，靠近北方的熊怪营地；"..YELLOW.."56.1,59.2"..WHITE.."）。"
...
Inst39Quest3_Location = "卡拉纳·明煌（灰谷 - 阿斯特兰纳；"..YELLOW.."35.9,51.6"..WHITE.."）。"
...
Inst39Quest3_HORDE_Location = "洛鲁克·林地行者（灰谷 - 裂木岗哨 "..YELLOW.."73.3,59.3"..WHITE.."）"
...
Inst44Quest5_Note = "请带上1个大块闪光碎片，你需要1个作为前置任务。附魔师或拍卖行可以帮助你获得，价格应该不贵。"
